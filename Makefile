...
parsers.o: parsers.cpp parsers.h manager.h value.h
	g++ -c $< -o $@

refcnt.o: refcnt.cpp refcnt.h
	g++ -c $< -o $@

sequencer.o: sequencer.cpp sequencer.h parsers.h sequencer.h synthesizer.h value.h manager.h macro.h chain_pool.h
	g++ -c $< -o $@
...
manager_test.o: manager_test.cpp manager.h
	g++ -c $< -o $@

parsers_test.o: parsers_test.cpp parsers.h value.h manager.h macro.h
	g++ -c $< -o $@

sequencer_test.o: sequencer_test.cpp synthesizer.h sequencer.h parsers.h value.h manager.h chain_pool.h macro.h
	g++ -c $< -o $@
